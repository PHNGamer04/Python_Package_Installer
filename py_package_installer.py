...
label0 = tk.Label(root, text='by Nikolopoulos', bg="SteelBlue4", fg="white")
label0.config(font=('helvetica', 12))
canvas1.create_window(240, 400, window=label0)

label1 = tk.Label(root, text='Όνομα Βιβλιοθήκης:', bg="SteelBlue4", fg="white")
label1.config(font=('helvetica', 16))
canvas1.create_window(150, 60, window=label1)

label2 = tk.Label(root, text='Βιβλιοθήκες:', bg="SteelBlue4", fg="white")
...
menu.add_command(label="Αποκοπή", command=cut_text) 
menu.add_command(label="Αντιγραφή", command=copy_text) 
menu.add_command(label="Επικόλληση", command=paste_text)
